...
**Os padrões entram sozinhos.** Antes, "aplicar os padrões de engenharia" dependia de alguém lembrar. Agora eles entram no plano automaticamente conforme o tipo de repositório — API, camada de agregação, web, mobile. Isso é a ideia de [padrões com dentes](Frontend%20como%20plataforma%20quando%20seu%20time%20vira%20provedor%20interno.md) funcionando na prática: a regra não depende de disciplina individual, ela está embutida no caminho.
...
Eu já escrevi sobre o dia em que descobrimos [seis implementações diferentes de validação de CPF](Frontend%20como%20plataforma%20quando%20seu%20time%20vira%20provedor%20interno.md) espalhadas pelos micro frontends. Aquilo levou anos para acontecer. A versão visual disso — seis amarelos, quatro sombras, três raios de borda para a mesma coisa — agora leva semanas. Um improviso por MR, entrando rápido demais para alguém notar.
...
Se isso te soa familiar, é porque é exatamente a mesma forma de [94% de cobertura e 0% de confiança](Testes%20Unitários%20no%20Frontend%20a%20arte%20de%20testar%20o%20que%20importa.md). O sistema verde que não estava protegendo nada. **Quem verifica também precisa ser verificado.**
...
Assim como no [efeito ENEM no código](O%20efeito%20ENEM%20no%20código%20como%20estudar%20para%20passar%20criou%20uma%20geração%20de%20devs%20inseguros.md), onde o hábito era entregar o mínimo para passar de fase sem entender o porquê, e assim como eu já escrevi sobre [os fundamentos na era da IA](O%20basico%20que%20separa%20quem%20usa%20IA%20de%20quem%20e%20usado%20por%20ela.md) — onde a fricção que sumiu era justamente onde o aprendizado acontecia — aqui o padrão se repete numa escala nova: **a fricção que sumiu era onde as decisões eram tomadas.**
