...
export const typographyClasses = {
  ...
  heroSubtitle: "font-normal text-lg md:text-xl leading-relaxed",

  // Section Headers
  sectionTitle: "font-bold text-3xl md:text-4xl leading-tight tracking-tight",
  sectionDescription: "font-normal text-base lg:text-xl leading-relaxed",

  // Content
  cardTitle: "font-semibold text-lg md:text-xl leading-snug",
  cardDescription: "font-normal text-sm md:text-base leading-relaxed",
  bodyText: "font-normal text-base leading-relaxed",
} as const;
